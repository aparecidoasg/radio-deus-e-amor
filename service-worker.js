...
const ASSETS = ["./", "./index.html", "./download.html", "./css/styles.css", "./js/script.js", "./js/stations.js", "./manifest.json", "./imgs/logo.png", "./imgs/qr-download.png", "./icons/icon-192.png", "./icons/icon-512.png"];
